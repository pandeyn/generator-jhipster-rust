...
- [CI/CD Integration](docs/CI_CD.md) - GitHub Actions, GitLab CI, and running locally with act
...
- **Local testing** - Run GitHub Actions locally using [act](https://github.com/nektos/act)
